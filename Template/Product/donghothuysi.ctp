            ...
            <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12">
                                <nav class="breadcrumb">
                                    ...
                                    <span class="breadcrumb-item active">ĐỒNG HỒ THỤY SỸ</span>
                                </nav>
                            </div>
                        </div> <!-- end of row -->
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title">ĐỒNG HỒ THỤY SỸ</span>
                    </h2>
                    ...
                    <ul class="row product-list grid filter">
                        <?php  while($result = $donghothuysi->fetch('assoc'))
                            {
                        ?>
                            ...
                            <div class="product-container product-resize fixheight" style="height: 298px;">
                                <div class="left-block image-resize" style="height: 221px;">
                                    ...
                                    <div class="add-to-cart">
                                        <a class="add-to-car" href="<?= $this->Url->build('/product/cart', true); ?>?acction=add&id=<?php echo $result["product_id"] ?>">Thêm vào giỏ</a>
                                    </div>
                        ...
                        <div class="block left-module">
                            ...
                            <div class="block_content">
                                <ul class="products-block best-sell">
                                    <?php  while($result = $hot->fetch('assoc'))
                                        {
                                    ?>
                                    <li class="clearfix">
                                        <div class="products-block-left">
                                            <a href="/san-pham/dam-body-ca-tinh-voi-nhieu-mau-sac-hien-dai-tre-trung.html"><?= $this->Html->image($result["image"]);?></a>
                                        </div>
                                        <div class="products-block-right">
                                            <p class="product-name">
                                                <a href="/san-pham/dam-body-ca-tinh-voi-nhieu-mau-sac-hien-dai-tre-trung.html"><?php echo $result["product_name"]?></a>
                                            </p>
                                            <p class="product-price">
                                                <span class=""><?=number_format($result["price"]). ' VNĐ'?></span>
                                                <span class="price old-price"><?=number_format($result["price1"]). ' VNĐ'?></span>
                                            </p>
