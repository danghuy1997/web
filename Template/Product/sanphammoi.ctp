            ...
            <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12">
                                <nav class="breadcrumb">
                                    ...
                                    <span class="breadcrumb-item active">SẢN PHẨM MỚI</span>
                                </nav>
                            </div>
                        </div> <!-- end of row -->
                ...
                <div id="view-product-list" class="view-product-list">
                    ...
                    <ul class="row product-list grid filter">
                        <?php  while($result = $new->fetch('assoc'))
                            {
                        ?>
                        <li class="col-md-3 col-sm-6 col-xs-12">
                            <div class="product-container product-resize fixheight" style="height: 298px;">
                                <div class="label-product label-sale" style="margin-right: 151px;"><?= $this->Html->image($result["avata"]);?></div>
